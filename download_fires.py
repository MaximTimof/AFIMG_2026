...
# меняю даты вручную чтобы не упало август, потом июль, потом июнь
TARGET_URL = "http://planet.iitp.ru/index.php?page_type=oper_prod&page=fire_report&start_date=2026-06-01&end_date=2026-06-30&region=all"
